          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-[11px] text-slate-400">
                  Exact numbers can come later — a range keeps recommendations realistic.
                </FormDescription>
                <FormMessage className="text-[11px]" />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-[11px] text-slate-400">
                  We&apos;ll tailor the invoice / checkout links to match this preference.
                </FormDescription>
                <FormMessage className="text-[11px]" />
              </FormItem>
            )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-[11px] text-slate-400">
                The more context you share, the more precise and realistic our quote will be.
              </FormDescription>
              <FormMessage className="text-[11px]" />
            </FormItem>
          )}
